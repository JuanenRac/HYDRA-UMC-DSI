...
static void my_application_activate(GApplication* application) {
  ...
  if (use_header_bar) {
    ...
    gtk_header_bar_set_title(header_bar, "HYDRA-UMC DSI");
    gtk_header_bar_set_show_close_button(header_bar, TRUE);
    gtk_window_set_titlebar(window, GTK_WIDGET(header_bar));
  } else {
    gtk_window_set_title(window, "HYDRA-UMC DSI");
  }
  ...
  // fixed size is a hint for the real kiosk deployment, not a hard app
  // requirement enforced at the Flutter layer.
